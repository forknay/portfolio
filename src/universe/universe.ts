      ...
      planets: [
        {
          ...
          // Reference "Paper Planes" planet: partial white cloud cover + faint rim.
          atmosphere: { type: "clouds", params: { count: 11 } },
        },
        {
          id: "atlas-tool",
          name: "Atlas Tool",
      ...
      planets: [
        {
          ...
          atmosphere: { type: "clouds", params: { count: 9 } },
        },
        {
          id: "skills",
          name: "Skills",
      ...
      planets: [
        {
          ...
          atmosphere: { type: "clouds", params: { count: 8 } },
        },
      ],
    },
  ],
